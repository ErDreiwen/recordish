...
public final class FrameProcessor {
    ...
    public void process(CapturedFrame frame, RecordableConfig config, long elapsedMillis, String username) {
     ...
     */
    public void processBakedCensors(CapturedFrame frame, RecordableConfig config) {
        if (frame == null || config == null) return;
    ...
    private void drawCensors(Graphics2D graphics, int width, int height, RecordableConfig config) {
