...
import dev.recordish.SmoothMotion;
...
public final class PerformanceScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        config.selectedDevicePreset =
                RecordishConfig.sanitizeDevicePreset(
                        config.selectedDevicePreset);
    ...
    private static String nextPreset(String current) {
        String[] presets = RecordishConfig.DEVICE_PRESETS;
    ...
    private static void cycleMotionMode(
            RecordishConfig config, CycleButton button) {
